...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7d1fd85b14c836d52b2515cddd42a149336eeb48a84b705953e3d33c04ddc1ae.js',function(){input.required=false;search();});}
